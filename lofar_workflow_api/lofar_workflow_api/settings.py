"""
Django settings for lofar_workflow_api project.
...
SECRET_KEY = '3p7v$fd*-6)x0(i&#a8d8xowbeikzf0wcq^!bvw6^@i3vq&8(t'
...
ROOT_URLCONF = 'lofar_workflow_api.urls'
...
WSGI_APPLICATION = 'lofar_workflow_api.wsgi.application'
